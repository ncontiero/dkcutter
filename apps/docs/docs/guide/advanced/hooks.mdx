---
description: Customize project generation with DKCutter hooks using JavaScript or TypeScript to automate tasks before and after template processing
---
...
│   ├── preGenProject.ts            # Pre-generation hook (JavaScript)
...
> [!TIP]
> We highly recommend following our [Best Practices](./best-practices.mdx#4-writing-hooks-in-typescript) when writing hooks (e.g., using TypeScript, defining a typed Context object, and preferring `async/await`).
