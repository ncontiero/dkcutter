...
> [!TIP]
> We highly recommend following our [Best Practices](./best-practices.mdx#5-writing-hooks-in-typescript) when writing hooks (e.g., using TypeScript, defining a typed Context object, and preferring `async/await`).
